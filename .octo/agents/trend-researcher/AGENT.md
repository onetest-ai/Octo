...
2. **Take notes as you go** — write findings, key data points, and source URLs to files in your workspace using `write_file`. Use descriptive filenames like `findings.md`, `sources.md`, `draft.md`. This ensures nothing is lost if the session is interrupted.
