...
Pure data structures (ProjectConfig, BUILTIN_PROFILES, parse helpers) live
in ``octo.core.constants`` and are re-exported here for backward compat.
"""
...
# Re-export pure constants from core (backward compat)
from octo.core.constants import (  # noqa: F401
    BUILTIN_PROFILES,
    DEFAULT_CLAUDE_CODE_TIMEOUT,
    DEFAULT_SUMMARIZATION_KEEP_TOKENS,
    DEFAULT_SUMMARIZATION_TRIGGER_TOKENS,
    DEFAULT_SUPERVISOR_MSG_CHAR_LIMIT,
...
_parse_interval = parse_interval
_parse_time_str = parse_time_str
...
_project_to_dict = project_to_dict
_project_from_dict = project_from_dict
...
# validate_project_name imported from octo.core.constants
_validate_project_name = validate_project_name
